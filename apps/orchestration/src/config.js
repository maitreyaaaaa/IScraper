...
function getConfig() {
  ...
  return {
    ...
    automationGenerationRateLimitPerMinute: Number(process.env.AUTOMATION_GENERATION_LIMIT_PER_MINUTE || 5),
    automationGenerationRateLimitPerDay: Number(process.env.AUTOMATION_GENERATION_LIMIT_PER_DAY || 20),
    automationRunRateLimitPerMinute: Number(process.env.AUTOMATION_RUN_LIMIT_PER_MINUTE || 5),
    automationRunRateLimitPerDay: Number(process.env.AUTOMATION_RUN_LIMIT_PER_DAY || 20),
    workflowGenerationRateLimitPerMinute: Number(process.env.WORKFLOW_GENERATION_LIMIT_PER_MINUTE || 5),
    workflowGenerationRateLimitPerDay: Number(process.env.WORKFLOW_GENERATION_LIMIT_PER_DAY || 20),
    mediaAnalysisRateLimitPerMinute: Number(process.env.MEDIA_ANALYSIS_LIMIT_PER_MINUTE || 5),
    mediaAnalysisRateLimitPerDay: Number(process.env.MEDIA_ANALYSIS_LIMIT_PER_DAY || 20),
    semanticEmbeddingRateLimitPerMinute: Number(process.env.SEMANTIC_EMBEDDING_LIMIT_PER_MINUTE || 60),
    semanticEmbeddingRateLimitPerDay: Number(process.env.SEMANTIC_EMBEDDING_LIMIT_PER_DAY || 1000),
