...
const LEGAL_CONTENT = {
  terms: {
    ...
    sections: [
      ...
      ['Your content', 'Your exports, saved links, captions, notes, summaries, graph data, username, onboarding preferences, and optional profile picture remain your content. You give IScraper permission to process that content only to provide the app features.'],
  ...
  privacy: {
    ...
    sections: [
      ...
      ['Account and auth data', 'Supabase Auth is the sign-in source of truth. We store app account records such as user ID, email, public support reference, profile state, username, onboarding preferences, timestamps, and account/deletion state. IScraper does not ask for Gmail, Drive, Calendar, contacts, or unrelated Google account content.'],
  ...
  dataDeletion: {
    ...
    sections: [
      ...
      ['What we delete', 'We can delete your account profile, onboarding preferences, saved items, imports, generated summaries, OCR/transcripts, graph data, provider key records, future extension tokens, and credit records tied to your account where deletion is legally and technically allowed.'],
